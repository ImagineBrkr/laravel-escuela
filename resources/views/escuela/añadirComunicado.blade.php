...
<div class="col-12 col-sm-10 col-lg-6">
    <form class="form" action="{{route('escuela.comunicados.ingresar')}}" method="POST">
        @csrf
      ...
      @enderror   
      <div class="form-group row my-2">
        <label for="descripcion" class="col-12 col-sm-2 col-form-label mb-2"><b>Comunicado</b></label>
        <div class="col-12 col-sm-10"><textarea class="form-control" id="descripcion" placeholder="Ingrese el comunicado" name="descripcion" maxlength="3000" rows="20" required></textarea></div>
      </div>  
      @error('descripcion')
      <div class="row">
          <strong style="color:red;">{{$message}}</strong>
